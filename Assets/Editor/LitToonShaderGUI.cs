...
namespace URPToon
{
    public class LitToonShaderGUI : BaseShaderGUI
    {
        #region Structs
        ...
        private struct PropertyNames
        {
            ...
            public static readonly string LightMap = "_LightMap";
            public static readonly string RampMap = "_RampMap";
        ...
        private MaterialProperty _lightMapProp;
        private MaterialProperty _rampMapProp;
        ...
        protected override void OnShaderGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            _lightMapProp = FindProperty(PropertyNames.LightMap, properties, false);
            _rampMapProp = FindProperty(PropertyNames.RampMap, properties, false);
            /*
        ...
        private void DrawBaseProperties()
        {
            ...
            DrawTextureProperty(_lightMapProp);
            DrawTextureProperty(_rampMapProp);
        }
